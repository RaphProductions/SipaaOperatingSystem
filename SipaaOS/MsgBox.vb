...
Public Class MsgBox
    ...
    Public Sub New()
        ...
        End If
    End Sub
    Public Sub Show(title As String, content As String, MSGIcon As MsgBoxType)
        If MSGIcon = MsgBoxType.Information Then
            PictureBox1.Image = My.Resources.icons8_info_48
        ElseIf MSGIcon = MsgBoxType.SError Then
            PictureBox1.Image = My.Resources.icons8_cancel_48
        ElseIf MSGIcon = MsgBoxType.Sucess Then
            PictureBox1.Image = My.Resources.icons8_ok_48
        ElseIf MSGIcon = MsgBoxType.Warning Then
            PictureBox1.Image = My.Resources.icons8_error_48
        End If
        Label1.Text = title
        Label2.Text = content
        Me.ShowDialog()
